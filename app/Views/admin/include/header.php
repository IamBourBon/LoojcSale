                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="/admin">
                            ...
                            <span class="logo-text">
                                <img src="<?php echo base_url('/assets/images/logo-light-text.png') ?> " class="dark-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                            ...
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="text-dark">
                                    <?php
                                        ...
                                        $session->destroy();
                                    ?>        
                                        <script>window.location.assign('/admin/login')</script>;  
                                    <?php
                                        }
                                        else{
                                            echo $session->get('s_username') ;
                                        }    
                                    ?>
